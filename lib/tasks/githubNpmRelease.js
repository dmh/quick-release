...
githubNpmRelease.go = async (cache) => {
  ...
  if (cache.githubRelease && cache.confirm.gitRelease && cache.confirm.gitPush && cache.confirm.githubRelease && cache.confirm.githubNpmRelease && cache.githubNpmRelease) {
