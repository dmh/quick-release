    ...
    return new Promise(function(resolve, reject) {
        ...
        inquirer.prompt(releaseType , function(answers) {
            if (answers) {
                ...
                reject(Error('in prompt.releaseType'));
            }
        });
    });
};
    ...
    return new Promise(function(resolve, reject) {
        ...
        inquirer.prompt(ver , function(answers) {
            if (answers) {
                ...
                reject(Error('in prompt.newVersion'));
            }
        });
    });
};
    ...
    return new Promise(function(resolve, reject) {
        ...
        inquirer.prompt(specifyVer , function(answers) {
            if (answers) {
                ...
                reject(Error('in prompt.specifyVer'));
            }
        });
    });
};
    ...
    return new Promise(function(resolve, reject) {
        ...
        inquirer.prompt(isGithubRelease , function(answers) {
            if (answers) {
                ...
                reject(Error('in prompt.isGithubRelease'));
            }
        });
    });
};
    ...
    return new Promise(function(resolve, reject) {
        ...
        inquirer.prompt(isNpmPublish , function(answers) {
            if (answers) {
                ...
                reject(Error('in prompt.isNpmPublish'));
            }
        });
    });
};

prompt.isGitPush = function isGitPush(cache) {
    return new Promise(function(resolve, reject) {
        let isGitPush = [
            {
                name: 'isGitPush',
        ...
        inquirer.prompt(isGitPush , function(answers) {
            if (answers) {
                helpers.addTo(cache, answers);
                resolve(cache);
            } else {
                reject(Error('in prompt.isGitPush'));
            }
        });
    });
};

prompt.isPackageJsonBump = function isPackageJsonBump(cache) {
    return new Promise(function(resolve, reject) {
        let isPackageJsonBump = [
            {
        ...
        inquirer.prompt(isPackageJsonBump , function(answers) {
            if (answers) {
                helpers.addTo(cache, answers);
                resolve(cache);
            } else {
                reject(Error('in prompt.isPackageJsonBump'));
            }
        });
    });
};
    ...
    return new Promise(function(resolve, reject) {
        ...
        inquirer.prompt(customProjectType , function(answers) {
            if (answers) {
                ...
                reject(Error('in prompt.customProjectType'));
            }
        });
    });
};
